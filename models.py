"""
Almost all codes from official HiFi-GAN (https://github.com/jik876/hifi-gan).
Only one exception is input size (line#80)
"""
...
class Generator(torch.nn.Module):
    def __init__(self, h):
        ...
        self.conv_pre = weight_norm(
            Conv1d(getattr(h, "model_in_dim", 128), h.upsample_initial_channel, 7, 1, padding=3)) # diff: `80` -> `getattr(h, "model_in_dim", 128)`
